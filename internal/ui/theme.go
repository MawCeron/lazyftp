...
var (
	...
	colorOverlayBg color.Color = lipgloss.Color("236") // modal/popup background, distinct from the base terminal background
)
...
func SetTheme(isDark bool) {
	...
	colorOverlayBg = ld(lipgloss.Color("253"), lipgloss.Color("236"))
}
